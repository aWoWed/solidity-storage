...
contract Getters is ChildContract, Types {
    ...
    bytes4 internal _functionSignature = bytes4(keccak256(bytes("transfer(address,uint256)")));
    ...
    mapping(uint256 => OneStorageSlotStruct) internal _oneStorageSlotStructMapping;
    uint256 internal _oneStorageSlotStructNestedMappingCounter;
    mapping(uint256 => mapping(address => OneStorageSlotStruct)) internal _oneStorageSlotStructNestedMapping;
    ...
    mapping(uint256 => mapping(address => BytesStruct)) internal _bytesStructNestedMapping;
    ...
    mapping(uint256 => mapping(address => StringStruct)) internal _stringStructNestedMapping;
    ...
    mapping(uint256 => mapping(address => ArrayStruct)) internal _arrayStructNestedMapping;
    ...
    mapping(uint256 => mapping(address => ParentStruct)) internal _parentStructNestedMapping;
    ...
    function getThirtyTwoBytesNumberArrayLength() public view returns(uint256) {
        return _thirtyTwoBytesNumberArray.length;
    }

    function getThirtyTwoBytesNumberArrayItem(uint256 id) public view returns(uint256) {
    ...
    function getSixteenBytesNumberArrayItem(uint256 id) public view returns(uint256) {
    ...
    function getStringArrayItem(uint256 id) public view returns(string memory) {
    ...
    function getNestedMappingItem(uint256 id, address _address) public view returns(bool) { 
        return _nestedMapping[id][_address];
    }

    function getOneStorageSlotStruct() public view returns(OneStorageSlotStruct memory) { 
        return _oneStorageSlotStruct;
    }

    function getOneStorageSlotStructArrayLength() public view returns(uint256) {
        return _oneStorageSlotStructArray.length;
    }

    function getOneStorageSlotStructArrayItem(uint256 id) public view returns(OneStorageSlotStruct memory) {
        return _oneStorageSlotStructArray[id];
    }

    function getOneStorageSlotStructMappingCounter() public view returns(uint256) {
        return _oneStorageSlotStructMappingCounter;
    }

    function getOneStorageSlotStructMappingItem(uint256 id) public view returns(OneStorageSlotStruct memory) { 
        return _oneStorageSlotStructMapping[id];
    }

    function getOneStorageSlotStructNestedMappingCounter() public view returns(uint256) {
        return _oneStorageSlotStructNestedMappingCounter;
    }

    function getOneStorageSlotStructNestedItem(uint256 id, address _address) public view 
    ...
    function getBytesStructArrayItem(uint256 id) public view returns(BytesStruct memory) {
    ...
    function getBytesStructMappingItem(uint256 id) public view returns(BytesStruct memory) { 
        return _bytesStructMapping[id];
    }

    function getBytesStructNestedMappingCounter() public view returns(uint256) {
        return _bytesStructNestedMappingCounter;
    }

    function getBytesStructNestedItem(uint256 id, address _address) public view 
    ...
    function getStringStructArrayItem(uint256 id) public view returns(StringStruct memory) {
    ...
    function getStringStructMappingItem(uint256 id) public view returns(StringStruct memory) { 
        return _stringStructMapping[id];
    }

    function getStringStructNestedMappingCounter() public view returns(uint256) {
        return _stringStructNestedMappingCounter;
    }

    function getStringStructNestedItem(uint256 id, address _address) public view 
    ...
    function getArrayStructArrayItem(uint256 id) public view returns(ArrayStruct memory) {
    ...
    function getArrayStructMappingItem(uint256 id) public view returns(ArrayStruct memory) { 
        return _arrayStructMapping[id];
    }

    function getArrayStructNestedMappingCounter() public view returns(uint256) {
        return _arrayStructNestedMappingCounter;
    }

    function getArrayStructNestedItem(uint256 id, address _address) public view 
    ...
    function getParentStructArrayItem(uint256 id) public view returns(ParentStruct memory) {
    ...
    function getParentStructMappingItem(uint256 id) public view returns(ParentStruct memory) { 
        return _parentStructMapping[id];
    }

    function getParentStructNestedMappingCounter() public view returns(uint256) {
        return _parentStructNestedMappingCounter;
    }

    function getParentStructNestedItem(uint256 id, address _address) public view 
